...
public class Main3Activity extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        else if (id == R.id.nav_rutastiempo) {
        ...
        }  else if (id == R.id.nav_actcontacto) {
            fragmentManager.beginTransaction().replace(R.id.contenedor,new Fragment04()).commit();

        } else if (id == R.id.nav_rutasfrecuentes) {
            fragmentManager.beginTransaction().replace(R.id.contenedor,new Fragment05()).commit();
